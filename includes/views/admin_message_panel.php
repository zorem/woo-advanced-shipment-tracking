<div class="admin-message-panel">
	<div class="admin-message-row">
		...
		<p>Get <strong>20% Off</strong> on your first order. Use code <strong>ASTPRO20</strong> to redeem your discount</p>
    	<a href="https://www.zorem.com/product/woocommerce-advanced-shipment-tracking/" class="button-primary btn_ast2" target="_blank">UPGRADE NOW</a>
	</div>
</div>